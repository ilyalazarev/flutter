...
import 'schema/rtyryy_record.dart';
...
export 'schema/rtyryy_record.dart';
export 'schema/users_record.dart';
export 'schema/chats_record.dart';
export 'schema/chat_messages_record.dart';

Stream<List<RtyryyRecord>> queryRtyryyRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(RtyryyRecord.collection, RtyryyRecord.serializer,
